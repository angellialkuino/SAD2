...
exports.seed = async function(knex) {
  ...
  await knex('users').insert([
    {user_id: uuid.v4(), role: 'customer', full_name: 'Angelli Kezzed M. Alkuino', phone_number: '09078216011', email: 'aaa@gmail.com', password: await bcrypt.hash('uhm', 10), fb_account: 'angelli.alkuino', full_address: 'address##adress'},
